...
if($conf_installed == "0"){
    header( 'Location: '.$conf_site_url.'/install/?new=true' ) ;
    exit;
}
...
if($count > 1){
    $featured_bar = "<a href='".$conf_site_url."/featured/'><img src='".$conf_site_url."/images/frontpage/featured_bar.png' class='tabs_framed''></a>";
}else{
    $featured_bar = "";
}
