            ...
            <head>
                ...
                <title><?=$conf_site_name?> - League Of Legends</title>
...
<div class="header_image" style="background-image:url(<?=$conf_site_url?>/images/header_lol.png)">&nbsp;</div>
...
<div class="header_menu">
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        <li class="current-menu-item" /><a href="<?=$conf_site_url?>/browse/lol/"><span>LoL</span></a></li>
