...
<title>GAMERS LIVE - League Of Legends</title>
...
<![endif]-->
			...
			$result = mysql_query("SELECT * FROM channels WHERE game='League Of Legends' AND online='Online' ORDER BY viewers DESC LIMIT $start_c, $end_c");

            $total_res = mysql_query("SELECT * FROM channels WHERE game='League Of Legends' AND online='Online'");
...
<div class="header_image" style="background-image:url(http://www.gamers-live.net/images/header_lol.png)">&nbsp;</div>
...
<div class="header_menu">
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        <li class="current-menu-item" /><a href="http://www.gamers-live.net/browse/lol/"><span>LoL</span></a></li>
