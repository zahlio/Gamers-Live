...
?>
            ...
            <head>
                ...
                <title><?=$conf_site_name?> - Minecraft</title>
...
<div class="header_image" style="background-image:url(<?=$conf_site_url?>/images/header_minecraft.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="<?=$conf_site_url?>/browse/minecraft/"><span>Minecraft</span></a></li>
