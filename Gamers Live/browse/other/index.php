...
$result = mysql_query("SELECT * FROM channels WHERE game='Other' AND online='Online' ORDER BY viewers DESC LIMIT $start_c, $end_c");
$total_res = mysql_query("SELECT * FROM channels WHERE game='Other' AND online='Online'");
...
<div class="header_image" style="background-image:url(http://www.gamers-live.net/images/header_other.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="http://www.gamers-live.net/browse/other/"><span>Others</span></a></li>
