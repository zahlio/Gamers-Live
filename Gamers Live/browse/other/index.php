...
<head>
    ...
    <title><?=$conf_site_name?> - Other</title>
...
<div class="header_image" style="background-image:url(<?=$conf_site_url?>/images/header_other.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="<?=$conf_site_url?>/browse/other/"><span>Others</span></a></li>
