...
<title>GAMERS LIVE - Starcraft 2</title>
...
$result = mysql_query("SELECT * FROM channels WHERE game='Starcraft 2' AND online='Online' ORDER BY viewers DESC LIMIT $start_c, $end_c");
$total_res = mysql_query("SELECT * FROM channels WHERE game='Starcraft 2' AND online='Online'");
...
<div class="header_image" style="background-image:url(http://www.gamers-live.net/images/header_sc2.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="http://www.gamers-live.net/browse/sc2/"><span>SC 2</span></a></li>
