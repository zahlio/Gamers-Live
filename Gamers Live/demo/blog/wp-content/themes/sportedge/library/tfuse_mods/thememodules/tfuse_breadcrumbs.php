...
function tfuse_breadcrumbs( $args = array() ) {
	...
	elseif ( is_home() ) {
		...
		$trail = array_merge( $trail, tfuse_breadcrumbs_get_parents( $home_page->post_parent, '' ) );
	...
	elseif ( is_archive() ) {
		...
		if ( is_tax() || is_category() || is_tag() ) {
			...
			if ( is_taxonomy_hierarchical( $term->taxonomy ) && $term->parent )
				$trail = array_merge( $trail, tfuse_breadcrumbs_get_parents( $term->parent, $term->taxonomy ) );
	...
	if ( is_array( $trail ) ) {
		...
		$breadcrumb = '<div class="breadcrumb breadcrumbs tfuse-breadcrumbs"><div class="breadcrumb-trail">';
