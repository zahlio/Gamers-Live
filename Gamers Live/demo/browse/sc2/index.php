...
?>
            ...
            <head>
                ...
                <title><?=$conf_site_name?> - Starcraft 2</title>
...
<div class="header_image" style="background-image:url(<?=$conf_site_url?>/images/header_sc2.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="<?=$conf_site_url?>/browse/sc2/"><span>SC 2</span></a></li>
