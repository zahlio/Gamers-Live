...
if ($_SESSION['access'] != true) {
    ...
    $login_box = '<div class="top_login_box"><a href="'.$conf_site_url.'/account/logout/">Logout</a><a href="'.$conf_site_url.'/account/settings/">Settings</a></div>';
            ...
            <head>
                ...
                <title><?=$conf_site_name?> - Call Of Duty</title>
...
<div class="header_image" style="background-image:url(<?=$conf_site_url?>/images/header_cod.png)">&nbsp;</div>
	...
	<div class="container">
        ...
        <div class="topmenu">
                    <ul class="dropdown">
                        ...
                        <li class="current-menu-item" /><a href="<?=$conf_site_url?>/browse/callofduty/"><span>Call Of Duty</span></a></li>
