                ...
                <div class="box2_content comment-form">
                    <form action="edit.php?id=<?=$id?>" method="post">
                        <div class="row">
                            <?php
                            // get kbase entry
                            $kbaseGet = mysql_query("SELECT * FROM kbase WHERE id='$id'")or die(mysql_error());
                            $kbaseGetRow = mysql_fetch_array($kbaseGet);
                            ?>
                            <label><b>Title</b></label>
                            <input name="title" id="title" type="text" value="<?=$kbaseGetRow['title']?>" class="inputtext input_full" style="width: 900px; height: 35px">
                            <label><b>Category</b></label>
                            <input name="cat" id="cat" type="text" value="<?=$kbaseGetRow['cat']?>"class="inputtext input_full" style="width: 900px; height: 35px">
                            <label><b>Message</b></label>
                            <textarea cols="30" rows="10" name="msg" id="msg" class="textarea textarea_middle required" style="width: 900px"><?=$kbaseGetRow['msg']?></textarea>
                        </div>

                        <input type="submit" value="Edit" class="btn-submit">
                    </form>
                    <a href="edit.php?id=<?=$id?>&delete=1" class="button_link btn_red"><span>DELETE</span></a>
                </div>
            </div>
            <!--/ content -->
